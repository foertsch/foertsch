...
**[FollowTheMoney](https://github.com/foertsch/FollowTheMoney)** — PDF bank statement parser for Swiss bank formats. Regex-based extraction, redaction pipeline, Excel output, CLI + macOS desktop launcher.
